...
/* harmony export (immutable) */ __webpack_exports__["calcFFT"] = calcFFT;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__lib_fft__ = __webpack_require__(2);


function calcFFT(inData, N) {

  const data = new __WEBPACK_IMPORTED_MODULE_0__lib_fft__["a" /* ComplexArray */](N).map((value, i) => {
    value.real = inData[i];
  });
